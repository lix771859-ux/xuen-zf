        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white px-4 py-4 border-b border-gray-200">
            ...
            <div className="flex items-baseline gap-2 mb-2">
              <span className="text-3xl font-bold text-blue-600">${property.price?.toLocaleString?.() ?? property.price}</span>
            ...
            <div className="mb-2">
              <span className="text-gray-700">评分：{property.rating ?? 4.5}（{property.reviews ?? 0}条评价）</span>
            </div>
            <div className="mb-2">
