...
export default function Home() {
  ...
  // 根据 URL 查询参数同步 tab 和当前会话（用于详情页跳转），支持多次跳转
  useEffect(() => {
                  ...
                  {conversations.map((conversation) => {
                    ...
                    return (
                      <div
                        ...
                        className="bg-white outline outline-2 outline-blue-500 shadow-lg rounded-lg p-4 flex items-start gap-3 hover:bg-gray-50 cursor-pointer"
                      >
                        <img
